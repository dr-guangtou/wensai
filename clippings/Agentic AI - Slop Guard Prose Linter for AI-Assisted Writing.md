---
title: "Agentic AI - Slop Guard: Prose Linter for AI-Assisted Writing"
...
| Text | Words | Score | Band |
| --- | --- | --- | --- |
| Atwood (2007) | 1,302 | 91 | clean |
| Dan Luu (2015) | 2,141 | 88 | clean |
| Gabriel (1989) | 1,672 | 83 | clean |
| PG: Maker's Schedule (2009) | 1,183 | 82 | clean |
| PG: Don't Scale (2013) | 4,424 | 81 | clean |
| Norvig (2001) | 2,757 | 63 | light |
| Our BM25 Post | 1,839 | 45 | moderate |
| Hamming (1986) | 14,454 | 39 | heavy |
| Pure AI Slop | 1,261 | 12 | saturated |
...
![Histogram of slop guard scores across 9,000 US public domain newspaper documents](https://raw.githubusercontent.com/eric-tramel/slop-guard/main/benchmark/output/score_histogram.png)

Figure 1. Score distribution over 9k documents from PleIAs/US-PD-Newspapers.
...
![Scatter plot of slop guard score vs document length across 9,000 US public domain newspaper documents](https://raw.githubusercontent.com/eric-tramel/slop-guard/main/benchmark/output/score_vs_length_scatter.png)

Figure 2. Score vs. document length (r = -0.134).
...
There’s existing work in this direction. [@myainotez](https://x.com/myainotez) pointed me to PrimeIntellect’s [community environments](https://github.com/PrimeIntellect-ai/community-environments) include an `antislop` environment built from similar word lists. But it uses coarse integer scoring (0-15 in 3-point buckets) with no density normalization and no concentration awareness. The continuous exponential scoring and the concentration multiplier produce a richer gradient signal for training.
...
![Eric W. Tramel, Ph.D.](https://eric-tramel.github.io/assets/images/profile.jpg)