...
2. [Claude.MD](https://claude.md/) (cached within a project)
...
2. **Use system messages instead of system prompt changes**. You may be tempted to edit the system prompt to do things like entering plan mode, changing the date, etc. but it would actually be better to insert these as system messages during the conversation.
